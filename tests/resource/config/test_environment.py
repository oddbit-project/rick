...
def test_environment_config_validators_success(cls, env_vars: dict, expected_result: dict):
...
@pytest.mark.parametrize("cls,env_vars,expected_exception,expected_message", validator_error_fixtures)
def test_environment_config_validators_failure(cls, env_vars: dict, expected_exception, expected_message: str):
